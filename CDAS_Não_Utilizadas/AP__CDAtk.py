...
def consultar_divida_ativa():
    ...
    try:
        ...
        nome_arquivo_excel = 'C:\\ProjetorPython\\Análise EFs - Débitos Unificados (7).xlsx'
        ...
        # Escreva a mensagem no Excel
            ...
            if "Nenhum resultado com os critérios de consulta" in resultado_msg:
                print(f"Para o CDA {Num_CDA}:")
                print("Nenhum resultado com os critérios de consulta. Lendo o próximo registro.")
                CDA = str(Num_CDA)
                #Gerar PDF da Tela
                ...
                sleep(2)
                pyautogui.click(245,402)
                sleep(2)
                new_func()
                sleep(2)
                pyautogui.write(CDA)
                sleep(2)
                pyautogui.click(511,471)
                sleep(2)
            ...
            valor_multa_element = driver.find_element(By.XPATH,"//tbody[@id='consultaDebitoForm:j_id1114:tb']//tr[contains(@class,'rich-table-row')]//td[@id='consultaDebitoForm:j_id1114:3:j_id1122']")
            valor_multa = valor_multa_element.text
            
            valor_honorarios_element = driver.find_element(By.XPATH,"//tbody[@id='consultaDebitoForm:j_id1114:tb']//tr[contains(@class,'rich-table-row')]//td[@id='consultaDebitoForm:j_id1114:4:j_id1122']")
            valor_honorarios = valor_honorarios_element.text
            
            valor_mora_multa_element = driver.find_element(By.XPATH,"//tbody[@id='consultaDebitoForm:j_id1114:tb']//tr[contains(@class,'rich-table-row')]//td[@id='consultaDebitoForm:j_id1114:5:j_id1122']")
        ...
        #Gerar PDF da Tela
            ...
            print(f"Para o CDA {Num_CDA}:")
            print("Número de Registro/CDA:", num_registro)
            print("Data de Inscrição:", data_inscricao)
            print("Número do Processo:", numero_processo)
            print("Número do Processo Outros:", numero_processo_outros)
            print("Situação:", situacao)
            print("Saldo:", saldo)
            print("Valor Principal:", valor_principal)
            print("Juros de Mora do Principal:", valor_juros)
            print("Multa de Mora do Principal:", valor_multa)
            print("Honorários Advocatícios:", valor_honorarios)
            print("Juros de Mora da Multa de Mora:", valor_mora_multa)
            print("Placa:", placa)
            print("Renavam:", renavam)
            print("Chassi:", chassi)
            print("Marca\Modelo:", marca_modelo)
            print("Ano:", ano_fab)
            print("Ano Exercicio:", ano_exercicio)
            print("Data Parcela:", dt_parcelas)
            print("-" * 40)
        ...
        messagebox.showinfo("Concluído", "A consulta foi concluída com sucesso!")
...
def selecionar_arquivo_excel():
    ...
    excel_file_path_entry.insert(0, file_path)

# Criar a janela principal
root = tk.Tk()
root.title("Consulta de Dívida Ativa")

# Rótulo e campo de entrada para o caminho do ChromeDriver
chrome_driver_label = tk.Label(root, text="")
chrome_driver_label.pack()
chrome_driver_path_entry = tk.Entry(root)
chrome_driver_path_entry.pack()

# Botão para selecionar o arquivo Excel
select_excel_button = tk.Button(root, text="Selecionar arquivo Excel", command=selecionar_arquivo_excel)
select_excel_button.pack()

# Rótulo e campo de entrada para o caminho do arquivo Excel
excel_file_label = tk.Label(root, text="")
excel_file_label.pack()
excel_file_path_entry = tk.Entry(root)
excel_file_path_entry.pack()

# Botão para iniciar a consulta
consulta_button = tk.Button(root, text="Iniciar Consulta", command=consultar_divida_ativa)
